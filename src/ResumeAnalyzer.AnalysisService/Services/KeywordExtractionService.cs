namespace ResumeAnalyzer.AnalysisService.Services
{
    ...
    public class KeywordExtractionService : IKeywordExtractionService
    {
        ...
        public Task<ResumeKeywords> ExtractAsync(string resumeText)
        {
            var foundSkills = _skills.Where(skill => resumeText.Contains(skill, StringComparison.OrdinalIgnoreCase)).ToList();

            return Task.FromResult(new ResumeKeywords
            {
